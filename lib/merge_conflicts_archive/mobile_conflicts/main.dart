...
Future<void> main() async {
  ...
  // Start the app immediately to avoid blocking the UI on heavy init work.
  runApp(const ProviderScope(child: MyApp()));

  // Initialize local storage (Hive) and Firebase in the background so
  // startup is fast. Log failures for debugging but don't block the UI.
